    ...
    public class Parameters
    {
        ...
        public string DeviceSecurityType { get; set; } = Program.SecretDic["IOTHUB_DEVICE_SECURITY_TYPE"];//Environment.GetEnvironmentVariable("IOTHUB_DEVICE_SECURITY_TYPE");
        ...
        public string PrimaryConnectionString { get; set; } = Program.SecretDic["IOTHUB_DEVICE_CONNECTION_STRING"];//Environment.GetEnvironmentVariable("IOTHUB_DEVICE_CONNECTION_STRING");
        ...
        public string DpsEndpoint { get; set; } = Program.SecretDic["IOTHUB_DEVICE_DPS_ENDPOINT"];//Environment.GetEnvironmentVariable("IOTHUB_DEVICE_DPS_ENDPOINT");
        ...
        public string DpsIdScope { get; set; } = Program.SecretDic["IOTHUB_DEVICE_DPS_ID_SCOPE"];//Environment.GetEnvironmentVariable("IOTHUB_DEVICE_DPS_ID_SCOPE");
        ...
        public string DeviceId { get; set; } = Program.SecretDic["IOTHUB_DEVICE_DPS_DEVICE_ID"];//Environment.GetEnvironmentVariable("IOTHUB_DEVICE_DPS_DEVICE_ID");
        ...
        public string DeviceSymmetricKey { get; set; } = Program.SecretDic["IOTHUB_DEVICE_DPS_DEVICE_KEY"];//Environment.GetEnvironmentVariable("IOTHUB_DEVICE_DPS_DEVICE_KEY");
